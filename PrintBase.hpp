...
public:   
   ...
   //---------------------------------------------------------------------
   void TriangleColored(TPoint &p1, TPoint &p2, TPoint &p3){

      TColorRGBA c1,c2,c3;
      c1.R =(float)p1.color[0]/255;c1.G =(float)p1.color[1]/255;c1.B =(float)p1.color[2]/255;c1.A =(float)p1.color[3]/255;
      c2.R =(float)p2.color[0]/255;c2.G =(float)p1.color[1]/255;c2.B =(float)p1.color[2]/255;c2.A =(float)p2.color[3]/255;
      c3.R =(float)p3.color[0]/255;c3.G =(float)p3.color[1]/255;c3.B =(float)p3.color[2]/255;c3.A =(float)p3.color[3]/255;
   ...
   void TriangleColoredFace(TPoint &p1, TPoint &p2, TPoint &p3){
