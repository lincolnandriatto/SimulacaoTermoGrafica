...
TrackBall::TrackBall(float p1x, float p1y, float p2x, float p2y, bool lock_x, bool lock_y)
{
    ...
    this->angPhi = (float) (2.0 * asin(t));


    this->Axis_Quat (axis, this->angPhi, this->currentQuat);
}
...
void TrackBall::setAngPhi(float phi)
{
    this->angPhi=phi;
}

float TrackBall::getQuat(int i)
{
    return this->currentQuat[i];
}
/*===================================================================*/
