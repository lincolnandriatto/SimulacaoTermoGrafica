...
public:
    ...
    float       CalcFontSize() const        { ImGuiContext& g = *GImGui; float scale = g.FontBaseSize * FontWindowScale*2.0; if (ParentWindow) scale *= ParentWindow->FontWindowScale*2.0; return scale; }
